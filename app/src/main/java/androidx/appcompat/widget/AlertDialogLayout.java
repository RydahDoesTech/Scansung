...
public class AlertDialogLayout extends AbstractC0649q0 {
    ...
    */
    public final void onLayout(boolean r11, int r12, int r13, int r14, int r15) {
        ...
        L51:
            ...
            k.p0 r7 = (k.C0647p0) r7
            int r8 = r7.gravity
            if (r8 >= 0) goto L74
            r8 = r3
        L74:
            java.util.WeakHashMap r9 = J.P.f1421a
        ...
        if (mode2 != 1073741824) {
            ...
            for (int i11 = 0; i11 < childCount; i11++) {
                ...
                if (childAt3.getVisibility() != 8) {
                    ...
                    if (((LinearLayout.LayoutParams) c0647p0).width == -1) {
                        int i12 = ((LinearLayout.LayoutParams) c0647p0).height;
                        ((LinearLayout.LayoutParams) c0647p0).height = childAt3.getMeasuredHeight();
                        measureChildWithMargins(childAt3, iMakeMeasureSpec, 0, i6, 0);
                        ((LinearLayout.LayoutParams) c0647p0).height = i12;
                    }
                }
            }
        }
