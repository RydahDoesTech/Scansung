...
public abstract /* synthetic */ class w {
    ...
    public static final /* synthetic */ int[] f3097b;
    ...
    static {
        ...
        f3096a = iArr;
        int[] iArr2 = new int[Q0.d(4).length];
        try {
            iArr2[0] = 1;
        ...
        int[] iArr4 = new int[EnumC0027i.values().length];
        try {
            iArr4[0] = 1;
        ...
        f3097b = iArr4;
        int[] iArr5 = new int[Q0.d(6).length];
        try {
            iArr5[0] = 1;
        ...
        int[] iArr8 = new int[Q0.d(3).length];
        try {
            iArr8[1] = 1;
