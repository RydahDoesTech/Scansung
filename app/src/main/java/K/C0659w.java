...
public class C0659w extends ImageButton {

    /* renamed from: d, reason: collision with root package name */
    public final B3.g f7827d;

    /* renamed from: e, reason: collision with root package name */
    public final A.d f7828e;
    public boolean f;
    ...
    public C0659w(Context context, AttributeSet attributeSet, int i5) {
    ...
    public final void drawableStateChanged() {
        ...
        B3.g gVar = this.f7827d;
        if (gVar != null) {
            gVar.a();
        }
        A.d dVar = this.f7828e;
        if (dVar != null) {
            dVar.a();
        }
    }
    ...
    public final boolean hasOverlappingRendering() {
        return !(((ImageView) this.f7828e.f11b).getBackground() instanceof RippleDrawable) && super.hasOverlappingRendering();
    }
    ...
    public final void refreshDrawableState() {
        ...
        if (!this.f7829g || getStateListAnimator() == null) {
            return;
        }
