...
public final class C0595J implements ListAdapter, SpinnerAdapter {

    /* renamed from: d, reason: collision with root package name */
    public SpinnerAdapter f7520d;

    /* renamed from: e, reason: collision with root package name */
    public ListAdapter f7521e;

    @Override // android.widget.ListAdapter
    public final boolean areAllItemsEnabled() {
        ListAdapter listAdapter = this.f7521e;
        if (listAdapter != null) {
    ...
    public final int getCount() {
        SpinnerAdapter spinnerAdapter = this.f7520d;
