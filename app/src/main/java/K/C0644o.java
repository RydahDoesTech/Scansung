...
public class C0644o extends AutoCompleteTextView {

    /* renamed from: d, reason: collision with root package name */
    public final B3.g f7754d;

    /* renamed from: e, reason: collision with root package name */
    public final V f7755e;
    public final C0388e f;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public C0644o(Context context, AttributeSet attributeSet) {
        super(context, attributeSet, R.attr.autoCompleteTextViewStyle);
        w1.a(context);
        v1.a(this, getContext());
        B3.g gVar = new B3.g(this);
        this.f7754d = gVar;
        gVar.g(attributeSet, R.attr.autoCompleteTextViewStyle);
        V v2 = new V(this);
        this.f7755e = v2;
        v2.f(attributeSet, R.attr.autoCompleteTextViewStyle);
        v2.b();
        C0388e c0388e = new C0388e((EditText) this);
        this.f = c0388e;
        c0388e.v(attributeSet, R.attr.autoCompleteTextViewStyle);
