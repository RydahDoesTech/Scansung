...
public abstract class K3 {
    ...
    public static final SparseArray f5328a;
    ...
    */
    public static V1.h a(com.google.android.gms.common.api.Status r4) {
        /*
            Method dump skipped, instructions count: 442
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p000firebaseauthapi.K3.a(com.google.android.gms.common.api.Status):V1.h");
    }

    public static String b(int i5) {
        Pair pair = (Pair) f5328a.get(i5);
        return pair != null ? (String) pair.first : "INTERNAL_ERROR";
    }

    public static String c(String str, Status status) {
        return TextUtils.isEmpty(status.f) ? str : String.format(String.valueOf(str).concat(" [ %s ]"), status.f);
    }
}
